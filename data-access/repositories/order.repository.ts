...
export class OrderRepository extends BaseRepository<Model<OrderAttributes>> {
  ...
  async findByID(
    req: Request,
    pkid: number,
  ): Promise<Model<OrderAttributes> | null> {
    return await super.findByID(req, pkid);
  }

  async where(
    req: Request,
    criteria: WhereOptions<OrderAttributes>,
    options?: FindOptions,
  ): Promise<Model<OrderAttributes>[]> {
  ...
  async whereExisting(
    req: Request,
    criteria: Partial<OrderAttributes>,
  ): Promise<boolean> {
  ...
  async findOne(
    req: Request,
    options: FindOptions<OrderAttributes>,
  ): Promise<Model<OrderAttributes> | null> {
    try {
  ...
  async create(
    req: Request,
    entity: CreationAttributes<Model<OrderAttributes>>,
  ): Promise<Model<OrderAttributes> | string> {
    return super.create(req, entity);
  }

  async bulkCreate(
    req: Request,
    entities: CreationAttributes<Model<OrderAttributes>>[],
  ): Promise<Model<OrderAttributes>[] | string> {
  ...
  async update(
    req: Request,
    pkid: number,
    entity: Partial<OrderAttributes>,
  ): Promise<[number, Model<OrderAttributes>[]]> {
    return super.update(req, pkid, entity);
  }

  async bulkUpdate(
    req: Request,
    entities: { pkid: number; values: Partial<OrderAttributes> }[],
  ): Promise<void> {
