...
export class TransactionController extends BaseController {
  ...
  public async getTransactionsByOrderId(
    ...
    try {
      ...
      const transactions =
        await this.transactionService.getTransactionsByOrderId(req, orderPkid);
  ...
  public async updateTransactionStatus(
    ...
    try {
      ...
      const transactionResultVM = new TransactionResultVM(
        affectedRows[0].toJSON(),
      );
  ...
  public async updateTransactionPaymentMethod(
    req: Request,
    res: Response,
  ): Promise<Response> {
    try {
      ...
      const [affectedCount, affectedRows] =
        await this.transactionService.updateTransactionPaymentMethod(
          req,
          pkid,
          payment_method,
        );
