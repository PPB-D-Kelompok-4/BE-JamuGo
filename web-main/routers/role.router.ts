...
router.get('/name/:name', (req, res) => roleController.findRoleByName(req, res));
...
// Delete methods
router.delete('/soft/:pkid', (req, res) => roleController.softDeleteRole(req, res));
router.delete('/hard/:pkid', (req, res) => roleController.hardDeleteRole(req, res));
router.post('/restore/:pkid', (req, res) => roleController.restoreRole(req, res));
